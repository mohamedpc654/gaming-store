...
const games = [
    ...
    { id: 3, name: 'A Plague Tale: Innocence (2019)', image: 'icons/a plague tale innocence.png', size: 45, description: 'A narrative-driven action-adventure game about two siblings surviving the Inquisition and rat hordes in medieval France.' },
    { id: 4, name: 'A Plague Tale: Requiem (2022)', image: 'icons/a plague tale requiem.png', size: 55, description: 'Sequel to Innocence, following Amicia and Hugo as they search for a cure amidst plague and persecution.' },
    ...
    { id: 17, name: 'Days Gone (2019)', image: 'icons/daysgone.png', size: 44, description: 'An open-world action game about a biker surviving a zombie apocalypse.' },
    ...
    { id: 35, name: 'Grand Theft Auto: The Trilogy - Definitive Edition (2023)', image: 'icons/Grand Theft Auto – The Definitive Edition.png', size: 32, description: 'Remastered versions of GTA III, Vice City, and San Andreas.' },
    ...
    { id: 60, name: 'NBA 2K23 (2022)', image: 'icons/nba 23.png', size: 110, description: 'A basketball simulation game.' },
